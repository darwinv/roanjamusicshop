...
<div class="btn-bar-rjm text-center container">
	<a data-idmusic="{$id_product}" data-idproduct="{$id_product}" data-href="{$modules_dir}roanjamusicshop/mp3/{$mp3_name}" class="sm2_button" title="{$mp3_title}" data-youtube="{if !empty($url_youtube)}{$url_youtube}{/if}" >
