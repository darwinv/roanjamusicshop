<div id="barra" name="barra" class="sm2-bar-ui full-width fixed {$oculto}" data-ruta="{$modules_dir}">
 ...
 <div class="bd sm2-main-controls">
  ...
  {if !empty($item_mp3.url_youtube)}
      <div class="sm2-inline-element sm2-button-element">
       <div class="sm2-button-bd">
      <a class="roanjayt fancybox fancybox.iframe youtube sm2-inline-button" href="https://www.youtube.com/embed/{$item_mp3.url_youtube}" >
       </a>
       </div>
      </div>
  {/if}
